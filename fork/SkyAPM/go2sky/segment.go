...
import (
	...
	"github.com/767829413/normal-frame/fork/SkyAPM/go2sky/reporter/grpc/common"
	v3 "github.com/767829413/normal-frame/fork/SkyAPM/go2sky/reporter/grpc/language-agent"
)

func newSegmentSpan(defaultSpan *defaultSpan, parentSpan segmentSpan) (s segmentSpan, traceID string, err error) {
	ssi := &segmentSpanImpl{
